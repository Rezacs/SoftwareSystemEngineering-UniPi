...
the command to launch the system should be : pyhton ingestion_launcher [--config_file_path=="example/example"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--testing_mode", type=bool, default=True, help="Launch the orchestrator in testing mode to generate logs (optional)")
    parser.add_argument("--config_file_path", type=str, default=None, help="path of the configuration file (optional)")

    args = parser.parse_args()

    orchestrator = IngestionSystemOrchestrator(args.config_file_path)
    orchestrator.start()