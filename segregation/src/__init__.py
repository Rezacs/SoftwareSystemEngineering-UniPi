...
SEGREGATION_DB_PATH = str(PROJECT_ROOT / "data" / "input" / "segregationDB.db")
...
SEGREGATION_WORKFLOW_STATE_PATH = str(PROJECT_ROOT / "data" / "input" / "segregation_workflow_state.json")
SEGREGATION_LOG_PATH = str(REPO_ROOT / "logs" / "segregationLog.json")
